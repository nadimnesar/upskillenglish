...
public class GenerateTrueFalseService {
    ...
    public ResponseEntity<?> create(String passage) {
        String prompt =  String.format("""
                Task: Generate 10 True/False questions from the passage using the specified JSON format. The questions should be designed for someone aiming to achieve an IELTS score of 7 or higher.
